...
var RefOptionList = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  React.useEffect(function () {
    for (var i = 0; i < activeValueCells.length; i += 1) {
      ...
      var ele = (_containerRef$current = containerRef.current) === null || _containerRef$current === void 0 ? void 0 : _containerRef$current.querySelector("li[data-path-key=\"".concat(cellKeyPath.replace(/(?<!\\)"/g, '\\"'), "\"]"));
